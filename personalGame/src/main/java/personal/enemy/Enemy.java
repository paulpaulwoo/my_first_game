...
public class Enemy extends Entity {
    ...
    protected int lookDirection; // changed by change state, 1 : right, 2 : left, 3 : up, 4 : down, 5 : spawn, 6 ~ 9 = attack, 11 ~ 14 = death
    protected int[] animationLengths; // length of each state's animation
    protected String[] animationPrefixes; //prefixes of each state's animation files' name
    protected String[] animationSuffixes; //suffixes of each state's animation files' name
    protected int[] dividers; //how long should each frame last in each animation
    protected int currentFrame = 0; //used to determine which frame to display
    protected int state = 1; // determines behavior on update & animation
    protected int totalImages; // total images of current animation 
    protected boolean changeReady = false; // is delayed doing current action
    protected int attackRange; //range of attack
    protected int attackWidth; //width of attack
    protected Player player; // player to target
    protected boolean stunned = false; // stunned. TO BE IMPLEMENTED
    protected int divider = 1; // how long should each frame last in current animation
    protected int delay = 0; // delay of current action
    protected float transparancy = 1f; //transparancy of sprite. 0 to 1
    protected int attackDamage; //damage of attacks
